...
import { dataRepNavGroups } from "@/lib/navigation";
...
export default function DataRepresentativePortal() {
  ...
  const handleExportPDF = () => {
    ...
    exportToPDF({ data, columns, title: 'تقرير طلبات ممثل البيانات', filename: 'data-rep-report', orientation: 'landscape' });
  };
  ...
  const handleExportExcel = () => {
    ...
    exportToExcel({ data, columns, title: 'تقرير طلبات ممثل البيانات', filename: 'data-rep-report' });
  };

  return (
    <DashboardLayout
      title="بوابة ممثل البيانات"
      subtitle="إدارة طلبات البيانات والردود"
      navGroups={dataRepNavGroups}
      portalName="ممثل البيانات"
    >
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <PremiumStatsCard 
            ...
            subtitle="من مكتب إدارة البيانات"
            delay={0}
          />
          ...
          <PremiumStatsCard 
            ...
            subtitle="تم الانتهاء هذا الشهر"
            delay={200}
          />
        </div>
        ...
        <GlassCard className="p-0 overflow-hidden">
          <div className="p-6 border-b border-[hsl(43_74%_49%)]/20">
            <h3 className="text-xl font-bold text-white flex items-center gap-3">
              ...
              الطلبات الواردة من مكتب البيانات
              ...
              <DialogBody className="space-y-6">
                ...
                <div className="p-4 rounded-xl bg-[hsl(222_47%_15%)]/50 border border-[hsl(43_74%_49%)]/20">
                  ...
                  <div className="flex gap-4 text-sm text-white/60">
                    ...
                    {requestDetail.request.dueDate && (
                      <span>الموعد النهائي: {new Date(requestDetail.request.dueDate).toLocaleDateString("ar-SA")}</span>
                    )}
                  </div>
