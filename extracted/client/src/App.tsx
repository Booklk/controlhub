...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/dmo/analytics">
        <ProtectedRoute component={DataAnalyticsPage} allowedPortals={DMO_PORTALS} />
      </Route>
      <Route path="/dmo/reports-center">
        <ProtectedRoute component={ReportsCenterPage} allowedPortals={DMO_PORTALS} />
      </Route>
